...
<table>
  <tr>
    <td><img src="/images/posts/Dev/circular-ref-error/hoc.png" alt="hoc 캡쳐본" height="400" /></td>
    <td><img src="/images/posts/Dev/circular-ref-error/hoc_index.png" alt="hoc 폴더 내의 index.tsx 캡쳐본" height="400" /></td>
  </tr>
</table>
...
> 트리 쉐이킹이란 **사용되지 않는 코드를 최종 번들에서 제거하여 번들 크기를 줄이는 최적화 기법**이다.  
> ESM(ECMAScript Module) 기반의 번들러(Webpack, Rollup 등)는 어떤 코드가 실제로 사용되었는지를 분석하여
